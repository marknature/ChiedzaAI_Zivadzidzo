...
export default function ReportsScreen() {
  ...
  return (
    <ScrollView className="flex-1 px-5 pt-14" style={{ backgroundColor: colors.bg }}>
      ...
      {predictions.map((prediction) => (
        <View key={prediction.id} className="mt-4 rounded-2xl border p-4" style={{ backgroundColor: colors.surface, borderColor: colors.border }}>
