...
// A report can contain a detailed institutional evidence trail and a signed download
// URL, so it is a leadership artifact rather than a staff-wide resource.
router.use(requireRole(...PREDICTION_WRITE_ROLES));
